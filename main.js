...
;// CONCATENATED MODULE: ./src/js/add_element.js


function addElement(value, container) {
  ...
  for (const message of value.response.messages) {
    ...
    const valiDate = moment_default()(received).format("HH:mm DD.MM.YYYY");
...
request$.subscribe(value => addElement(value, document.querySelector(".container")));
